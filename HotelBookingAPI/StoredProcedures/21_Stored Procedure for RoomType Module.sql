-- This script contains the stored procedures for the RoomType module

-- Create Room Type
CREATE 
	OR
ALTER PROCEDURE spCreateRoomType @TypeName NVARCHAR(50)
...
ALTER PROCEDURE spUpdateRoomType @RoomTypeID INT
...
ALTER PROCEDURE spDeleteRoomType @RoomTypeID INT
	,@StatusCode INT OUTPUT
	,@Message NVARCHAR(255) OUTPUT
AS
BEGIN
...
ALTER PROCEDURE spGetRoomTypeById @RoomTypeID INT
AS
BEGIN
	SET NOCOUNT ON;
...
ALTER PROCEDURE spGetAllRoomTypes @IsActive BIT = NULL -- Optional parameter to filter by IsActive status
AS
BEGIN
	SET NOCOUNT ON;
...
ALTER PROCEDURE spToggleRoomTypeActive @RoomTypeID INT
	,@IsActive BIT
	,@StatusCode INT OUTPUT
	,@Message NVARCHAR(255) OUTPUT
AS
