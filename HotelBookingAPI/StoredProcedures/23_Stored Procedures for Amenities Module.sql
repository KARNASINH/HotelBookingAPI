-- This script contains stored procedures for managing amenities related operations in the database.
...
ALTER PROCEDURE spFetchAmenities 
	 @IsActive BIT = NULL
	,@Status BIT OUTPUT
...
ALTER PROCEDURE spFetchAmenityByID 
	@AmenityID INT
AS
BEGIN
	SET NOCOUNT ON;
...
ALTER PROCEDURE spUpdateAmenity 
	 @AmenityID INT
	,@Name NVARCHAR(100)
	,@Description NVARCHAR(255)
	,@IsActive BIT
...
ALTER PROCEDURE spDeleteAmenity 
	 @AmenityID INT
	,@Status BIT OUTPUT
	,@Message NVARCHAR(255) OUTPUT
AS
...
ALTER PROCEDURE spBulkInsertAmenities 
...
ALTER PROCEDURE spBulkUpdateAmenities 
...
ALTER PROCEDURE spBulkUpdateAmenityStatus 
