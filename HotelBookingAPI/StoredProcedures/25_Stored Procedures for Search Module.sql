-- This script contains stored procedures for the search module of the hotel booking system.
...
ALTER PROCEDURE spSearchByAvailability 
	 @CheckInDate DATE
	,@CheckOutDate DATE
AS
BEGIN
	...
	WHERE res.RoomID IS NULL
		AND r.STATUS NOT IN ('Under Maintenance')
		AND r.IsActive = 1;
END
GO
...
ALTER PROCEDURE spSearchByPriceRange 
...
ALTER PROCEDURE spSearchByRoomType 
...
ALTER PROCEDURE spSearchByViewType 
...
ALTER PROCEDURE spSearchByAmenities 
...
ALTER PROCEDURE spSearchRoomsByRoomTypeID 
	@RoomTypeID INT
AS
BEGIN
	SET NOCOUNT ON;
...
ALTER PROCEDURE spGetRoomDetailsWithAmenitiesByRoomID 
	@RoomID INT
AS
BEGIN
	SET NOCOUNT ON;-- Suppresses the 'rows affected' message
...
ALTER PROCEDURE spGetRoomAmenitiesByRoomID 
	@RoomID INT
AS
BEGIN
	SET NOCOUNT ON;-- Suppresses the 'rows affected' message
...
ALTER PROCEDURE spSearchByMinRating 
	@MinRating FLOAT
AS
BEGIN
	SET NOCOUNT ON;
...
ALTER PROCEDURE spSearchCustomCombination 
