-- This script contains stored procedures for the RoomAmenities module of the Hotel Booking API.

-- Stored Procedure for Fetching All RoomAmenities by RoomTypeID
CREATE
	OR

ALTER PROCEDURE spFetchRoomAmenitiesByRoomTypeID 
	@RoomTypeID INT
AS
BEGIN
	SET NOCOUNT ON;
...
ALTER PROCEDURE spFetchRoomTypesByAmenityID 
	@AmenityID INT
AS
BEGIN
	SET NOCOUNT ON;
...
ALTER PROCEDURE spAddRoomAmenity 
	 @RoomTypeID INT
	,@AmenityID INT
	,@Status BIT OUTPUT
...
ALTER PROCEDURE spDeleteSingleRoomAmenity 
	 @RoomTypeID INT
	,@AmenityID INT
	,@Status BIT OUTPUT
	,@Message NVARCHAR(255) OUTPUT
...
ALTER PROCEDURE spBulkInsertRoomAmenities 
	 @RoomTypeID INT
...
ALTER PROCEDURE spBulkUpdateRoomAmenities 
	 @RoomTypeID INT
	,@AmenityIDs AmenityIDTableType READONLY
	,@Status BIT OUTPUT
	,@Message NVARCHAR(255) OUTPUT
...
ALTER PROCEDURE spDeleteAllRoomAmenitiesByRoomTypeID 
	 @RoomTypeID INT
	,@Status BIT OUTPUT
	,@Message NVARCHAR(255) OUTPUT
AS
...
ALTER PROCEDURE spDeleteAllRoomAmenitiesByAmenityID 
	 @AmenityID INT
	,@Status BIT OUTPUT
	,@Message NVARCHAR(255) OUTPUT
AS
